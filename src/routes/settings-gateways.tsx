    ...
    <div className="bg-black min-h-screen text-white pb-24 -mx-4 px-4 sm:-mx-8 sm:px-8">
      <div className="mx-auto max-w-4xl space-y-6 pt-6">
        ...
        <div className="flex flex-col items-center gap-2 py-4 mt-2">
          <div className="flex w-full items-center gap-4 rounded-2xl border border-white/5 bg-[#111116] p-4 shadow-lg">
          ...
          <div className="flex w-full items-center gap-4 rounded-2xl border border-[#a855f7]/30 bg-[#a855f7]/10 p-4 shadow-[0_0_20px_rgba(168,85,247,0.15)] relative overflow-hidden">
            ...
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#a855f7] text-white shadow-[0_0_10px_rgba(168,85,247,0.5)] z-10"><Server className="h-5 w-5" /></div>
            <div className="text-left z-10"><p className="font-bold text-sm text-white">Local Integration Gateway</p><p className="text-xs font-medium text-[#a855f7] mt-0.5">Home Assistant · MQTT Broker</p></div>
          </div>
