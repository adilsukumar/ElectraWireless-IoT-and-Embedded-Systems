      ...
      <div className="mx-auto max-w-4xl space-y-6 pt-6">
        ...
        <div className="flex gap-3">
          <button 
            ...
            className={cn("flex-1 py-4 rounded-2xl flex flex-col items-center gap-2 transition-all active:scale-95 border border-border/20", consoleState === 'Active' ? "bg-purple-500/20 text-purple-400 border-purple-500/30 shadow-[0_0_10px_rgba(168,85,247,0.2)]" : "bg-neutral-800/50 text-neutral-400")}
          >
          ...
          <button 
            ...
            className={cn("flex-1 py-4 rounded-2xl flex flex-col items-center gap-2 transition-all active:scale-95 border border-border/20", consoleState === 'Standby' ? "bg-purple-500/20 text-purple-400 border-purple-500/30 shadow-[0_0_10px_rgba(168,85,247,0.2)]" : "bg-neutral-800/50 text-neutral-400")}
          >
          ...
          <button 
            ...
            className={cn("flex-1 py-4 rounded-2xl flex flex-col items-center gap-2 transition-all active:scale-95 border border-border/20", consoleState === 'Off' ? "bg-red-500/20 text-red-400 border-red-500/30 shadow-[0_0_10px_rgba(239,68,68,0.2)]" : "bg-neutral-800/50 text-neutral-400")}
          >
            <Power className="w-6 h-6" />
        ...
        {/* Status Info */}
        <div className="flex justify-between items-center bg-neutral-800/40 p-4 rounded-2xl border border-border/20">
           <div className="flex items-center gap-3">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <button onClick={() => handleAction('Launching App')} className="aspect-square rounded-2xl bg-neutral-800/80 border border-border/20 flex items-center justify-center hover:scale-[1.02] active:scale-95 transition shadow-lg text-neutral-400 hover:text-foreground">
