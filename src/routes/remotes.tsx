  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 pb-20">
      ...
      <div className="grid grid-cols-2 gap-4">
        {/* LIVING ROOM TV */}
        <Link to="/tv-remote" className="flex flex-col items-center justify-center gap-3 py-6 px-4 rounded-[2rem] bg-[#111116] border border-white/5 transition-all hover:bg-[#181820] hover:scale-[1.02] active:scale-95 group shadow-lg">
        ...
        {/* SMART FRIDGE */}
        <Link to="/fridge-remote" className="flex flex-col items-center justify-center gap-3 py-6 px-4 rounded-[2rem] bg-[#111116] border border-white/5 transition-all hover:bg-[#181820] hover:scale-[1.02] active:scale-95 group shadow-lg">
        ...
        {/* HOME AUDIO SYSTEM */}
        <Link to="/audio-remote" className="flex flex-col items-center justify-center gap-3 py-6 px-4 rounded-[2rem] bg-[#111116] border border-white/5 transition-all hover:bg-[#181820] hover:scale-[1.02] active:scale-95 group shadow-lg">
        ...
        {/* GAME CONSOLE */}
        <Link to="/console-remote" className="flex flex-col items-center justify-center gap-3 py-6 px-4 rounded-[2rem] bg-[#111116] border border-white/5 transition-all hover:bg-[#181820] hover:scale-[1.02] active:scale-95 group shadow-lg">
        ...
        {/* ADD REMOTE */}
        <button onClick={handleAddRemote} className="flex flex-col items-center justify-center gap-3 py-6 px-4 rounded-[2rem] bg-[#111116]/50 border-2 border-dashed border-white/10 transition-all hover:bg-[#181820] hover:border-white/20 hover:scale-[1.02] active:scale-95 group shadow-none">
